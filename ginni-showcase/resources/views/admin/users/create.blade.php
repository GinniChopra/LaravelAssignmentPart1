            ...
            <form method="POST" action="/admin/users/create">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" required
                        class="border border-gray-400 rounded p2 w-full" value="{{ old('name') ?? $user?->name }} ">
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="email" id="email" required
                        class="border border-gray-400 rounded p2 w-full" value="{{ old('email') ?? $user?->email}}">
                    @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="password" id="password" required
                        class="border border-gray-400 rounded p2 w-full" value="">
                    @error('password')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
