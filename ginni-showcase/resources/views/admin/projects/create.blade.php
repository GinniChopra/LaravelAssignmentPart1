            ...
            <form method="POST" action="/admin/projects/create">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="excerpt" id="excerpt" required
                        class="border border-gray-400 rounded p2 w-full"
                        value="{{ old('excerpt') ?? $project?->excerpt }}">
                    @error('excerpt')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="body" id="body" required
                        class="border border-gray-400 rounded p2 w-full" value="{{ old('body') ?? $project?->body }}">
                    @error('body')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <label for="published_date" class="block mb-2 uppercase font-bold text-xs text-gray-700">Date</label>
                    <input type="date" name="published_date" id="published_date" class="border border-gray-400 rounded p2 w-full"
